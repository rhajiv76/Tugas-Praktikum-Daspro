...
int main(){
	...
	cout<<"NAMA            : YULINAR"<<endl;
	cout<<"NIM             : F1G121089"<<endl;
	...
	ulang:
		...
		//di halaman registrasi ini program saya akan menyuruh memasukkan user name dan password yang akan saya buat
